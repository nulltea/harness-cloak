...
**verdict:** `no` (no cheap post-hoc signal separates real detected entities from noise; NLI-substitution v3 pending as the last test)  ·  **confidence:** `high`  ·  tests `idea:semantic-detector-noise-gate`
...
| **NLI v3 (substitution frame, `nli_gate`)** | _pending real run_ | _pending_ | ~v2 | deciding test — well-posed query |
