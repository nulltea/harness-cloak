...
Fact-check a draft using the **Post-Flight Verification protocol** ([`rules/post-flight-verification.md`](../../../rules/post-flight-verification.md)).
...
- `claim-verifier` agent file exists at `agents/claim-verifier.md`
...
- [`agents/claim-verifier.md`](../../../agents/claim-verifier.md) — the forked verifier.
- [`rules/post-flight-verification.md`](../../../rules/post-flight-verification.md) — the protocol.
