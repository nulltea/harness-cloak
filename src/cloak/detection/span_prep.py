...
from cloak.detection.detect import Detector, Span, coref_chains, relabel_dem
from cloak.lattice.core import TYPE_LABEL, lattice_for, NO_PREPASS
from cloak.lattice.profiles import lookup_entry
from cloak.detection.probe import walk_risk
...
if __name__ == "__main__":
    ...
    print("detection/span_prep.py self-check OK")
