...
Layered below ``qa.builder``, so it also owns the relation-class tables and the
...
from cloak.qa.scoring import CLAUSE_DELIMITER_PATTERN, canon, occurrence_protected_terms
