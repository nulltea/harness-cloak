...
from cloak.lattice.profile_match import DEFAULT_MODEL_ID, SIM_FLOOR, _st_model
from cloak.detection.detect import QA_V2_CLINICAL_LABELS
from cloak.lattice.profile_match import PROFILE_BACKED_TYPES
    ...
    *,
    ...
    if source_documents is not None:
        if pair_nli_batch_fn is None or self_type_nli_batch_fn is None:
            from cloak.lattice.core import nli_gate_batch
