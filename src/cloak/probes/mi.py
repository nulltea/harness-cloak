...
if __name__ == "__main__":
    # ponytail: the token_channel_mi self-check needed the retired RANTEXT Perturber +
    # VocabEmbeddings; both functions still take any perturber, so only the demo shrank.
